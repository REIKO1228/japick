        ...
        body: JSON.stringify({
          contents: [{
            parts: [
              ...
              {
                text: `この画像にはJANコード（EAN-13）のバーコードが写っています。バーコードは横向きや斜めになっている場合があります。どの向きでも構いません。バーコードの数字を読み取り、13桁または8桁の数字のみを返してください。数字以外は一切返さないでください。バーコードが全く見つからない場合のみ「NOT_FOUND」と返してください。`
              }
            ]
          }],
          generationConfig: {

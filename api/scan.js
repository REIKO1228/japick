        ...
        body: JSON.stringify({
          contents: [{
            parts: [
              ...
              {
                text: `画像に写っているバーコードの真下に印刷されている数字列を読んでください。数字だけを返してください。例：4901670110227バーコードは横向きや斜めになっている場合があります。どの向きでも構いません。バーコードの数字を読み取り、13桁または8桁の数字のみを返してください。数字以外は一切返さないでください。バーコードが全く見つからない場合のみ「NOT_FOUND」と返してください。`
              }
            ]
          }],
          generationConfig: {

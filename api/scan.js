        ...
        body: JSON.stringify({
          contents: [{
            parts: [
              ...
              {
                text: `この画像に写っているバーコード（JANコード・EANコード・UPCコード）の数字を読み取って、数字のみを返してください。バーコードが複数ある場合は最も大きく写っているものを1つだけ返してください。数字以外のテキスト（説明文など）は一切含めないでください。バーコードが見つからない場合は「NOT_FOUND」とだけ返してください。`
              }
            ]
          }],
          generationConfig: {
